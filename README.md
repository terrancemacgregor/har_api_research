...
## Example
For example, if you were to view a sample site like this: www.cats.com/order_kitten , you would see the results in your browser.
...
* www.cats.com/kittens/343?color=orange
* www.cats.com/kittens/location=new_york
* ...
